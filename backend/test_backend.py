...
def test_orchestrated_text_only_required_timeout_returns_final_unverified(monkeypatch):
    job = {
    ...
    # Timeout is terminal: do not keep polling forever when the final state is UNVERIFIED.
